...
// api.openweathermap.org/data/2.5/weather?q=Rostov-on-Don,ru&appid=079f12524e5a8d17ad0b0a1ffa340869&units=metric



function Rostov(cityName) {
    ...
    return (
        <>
        {days.length === 0 ? <Spinner/> : <Main days={days}/>}
